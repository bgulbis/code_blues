...
SELECT DISTINCT
	...
	pi_from_gmt(CODE_DATES.START_DATETIME, (pi_time_zone(1, @Variable('BOUSER')))) AS CODE_START_DATETIME,
	pi_from_gmt(CODE_DATES.STOP_DATETIME, (pi_time_zone(1, @Variable('BOUSER')))) AS CODE_STOP_DATETIME
FROM CODE_DATES